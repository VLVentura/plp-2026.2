 ...
 */
package project.plp.functional1.memory;

import project.plp.expressions2.expression.Id;
import project.plp.expressions2.memory.IdentificadorJaDeclaradoException;
import project.plp.expressions2.memory.IdentificadorNaoDeclaradoException;
