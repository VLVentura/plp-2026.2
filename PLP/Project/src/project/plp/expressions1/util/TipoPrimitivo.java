package project.plp.expressions1.util;
...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see project.plp.expressions1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see project.plp.expressions1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see project.plp.expressions1.util.Tipo#eString()
	 */
	...
	/* (non-Javadoc)
	 * @see project.plp.expressions1.util.Tipo#eValido()
	 */
